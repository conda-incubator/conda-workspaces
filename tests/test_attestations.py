...
def test_workspace_attestation_round_trip(
    ...
    pytest.importorskip("conda_sigstore.statements")
...
def test_sigstore_settings_translate_invalid_configuration(
    ...
    SigstoreSettings = pytest.importorskip("conda_sigstore.settings").SigstoreSettings
...
def test_sign_attestation_delegates_exact_validated_payload(
    ...
    pytest.importorskip("conda_sigstore.attestation")
